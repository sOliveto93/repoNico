...
public abstract class AbmServlet extends HttpServlet implements Servlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(operacion!=null && usuario != null){
				...
				if (operacion.equals(this.getIngresarLabel())){
					
					this.ingresar(request, response);
					
				} else 	if (operacion.equals(this.getEliminarLabel())){
					
					this.eliminar(request, response);
						
				} else if(operacion.equals(this.getAgregarLabel())){
					
					this.agregar(request, response);
					
				} else if (operacion.equals(this.getModificarLabel())){
					
					this.modificar(request, response);
					
				} else {
					this.otroProceso(request, response);				
				}
	...
	public abstract void ingresar(HttpServletRequest request, HttpServletResponse response);
	
	public abstract void agregar(HttpServletRequest request, HttpServletResponse response);
	
	public abstract void eliminar(HttpServletRequest request, HttpServletResponse response);
	
	public abstract void modificar(HttpServletRequest request, HttpServletResponse response);
	
	public void otroProceso(HttpServletRequest request, HttpServletResponse response){
		// Sin funcionalidad en esta clase
	}
	
	public abstract String getSaltoDefault();
	
	public abstract String getIngresarLabel();
	
	public abstract String getAgregarLabel();
	
	public abstract String getEliminarLabel();
	
	public abstract String getModificarLabel();
