...
public class RubroCobroServlet extends MappingMethodServlet {
	
	public RubroCobroServlet(){
	...
	public void alta(){
		RubroCobro rubroCobro = getRubroCobroActualizado();
...
//		FactoryDAO.eventoDAO.save(evento,false);
	...
	public void modificar(){
		try{
			...
			rubroCobro = getRubroCobroActualizado();
...
//			FactoryDAO.eventoDAO.save(evento,false);
	...
	public void borrar(){
		...
		//AGREGAR COLUMNA ESTADO EN LA TABLA
//		Evento evento = getEventoAuditoria(request, rubroCobro);
//		
//		FactoryDAO.eventoDAO.save(evento,false);
	...
	public RubroCobro getRubroCobroActualizado(){
