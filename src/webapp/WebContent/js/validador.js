...
a_messages = [
	'No se paso el nombre del validador al constructor',
	'No se paso el arreglo de campos del form "%form%" al contructor',
	'El form "%form%" no se encuentra en el documento',
	'El "%n%" descriptor del campo del form es incompleto. Falta el atributo "l"',
	'No se puede encotrar el campo "%n%" en el form "%form%"' ,
	'No se encuentra la etiqueta (id="%t%")',
	'No se puede verificar que coincidan. No se encontro el par "%m%"',
	'El campo "%l%" es requerido',
	'El valor de "%l%" debe ser de por lo menos "%mn%" caracteres',
	'El valor de "%l%" debe ser de no mas de "%mx%" caracteres',
	'"%v%" no es un valor valido para "%l%"',
	'"%l%" debe coincidir con "%ml%"'	
]
