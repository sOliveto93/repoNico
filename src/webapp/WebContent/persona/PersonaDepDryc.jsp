...
$(function(){
    ...
    $('#tablaPersonas').fixheadertable({
        caption   : 'Personas',
        colratio    : [26, 320, 320,50,80,80,26,26],  //colratio    : [26, 320, 320,50,80,80,26,26,26,26],
        height      : 200, 
        width       : 955, 
        zebra       : true
   });
...
function mostrarCarreras(inscripciones){
	...
	for(i=0;i<inscripciones.length;i++){
			console.log(usuarioGlobalTipoUsuario);
...
<body onload="javascript:loadUser('${usuario.tipo}');">
	<div class="recuadro">
		...
		<c:set var="salto" value="/persona/PersonaDepDryc.jsp"/>
		...
		<table id="tablaPersonas" class="fixheadertable">
			<thead>
				<tr>
					...
					<th>Documento</th>
					<th>Fec. Ingreso</th>
					<th><img src="images/ojo.png" width="24px" title="Ver datos personales"/></th>
					<th><img src="images/signoPeso2.png" width="24px" title="Ver Cuotas"/></th>
				</tr>
			</thead>
				...
				<c:forEach items="${personas}"  var="persona">
					<c:if test="${persona.estado.activado}"> 
						<tr>
							...
							<td><a href="javascript:mantenimientoPersona('${persona.id}');"><img src="images/ojo.png" width="15px"/ title="Modificar datos personales (${persona.nombre})"></a></td>
