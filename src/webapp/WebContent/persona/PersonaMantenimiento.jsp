...
function filaJson(pago){
	...
	if((pago.estado.valor == "Incierto") || (!isEmpty(pago.fechaPgo))){
		...
		jsonObj.put("tipoPago",tipoPagoJson);		
			...
			origenPago,tipoPago,codigoTodoPago,fechaPagoCarga,codigoTodoPago,monto1,
			pago.origenPago.descripcion+','+pago.tipoPago.descripcion+','+	pago.codigoTodoPago+','+pago.fechaPagoCarga+','+
			
		*/

		/*
		pago.origenPago.descripcion
...
<body  onload="doOnLoad('${operacion}','${persona.documento.tipo.abreviacion}');">
<div class="recuadro">
	...
	<div id="datosPersona"  align="left" style="display: none;">
		<%@  include file="PersonaDatosAcademicosyPersonales.jsp"  %>
	</div>
 	<div id="cuotasPersona"  align="left" style="display: none;">
		<%@ include file="PersonaCuotas.jsp" %>
	</div>
	<div id="facturasPersona"  align="left" style="display: none;">
		<%@ include file="PersonaFacturas.jsp" %>
	</div>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
...
function doOnLoad(operacion,tipoDocumento){
