	...
	<tbody>
		<c:forEach items="${facturas}"  var="factura">
				<tr>
					...
					<c:if test="${usuario.tipo == AUDITORIA || usuario.tipo == DRIYC || usuario.tipo == DEP || usuario.tipo == DEPADMIN || usuario.tipo == DRCADMIN}">
						<td>
							<img src="images/deleteGris.png" width="15px" title="" />
						</td>
					</c:if>
				</tr>
		</c:forEach>
